 ...
 *
class DLXNodeHeinz{       // represents 1 element or header
  DLXNodeHeinz C;           // reference to column-header
  DLXNodeHeinz L, R, U, D;  // left, right, up, down references
  DLXNodeHeinz(){ C=L=R=U=D=this; } // supports circular lists
   ...
   * @param DLXNodeHeinz c: header element of column that has to be covered
   *
   *
   ...
   * @param DLXNodeHeinz c: header element of column that has to be uncovered
   *
   *
